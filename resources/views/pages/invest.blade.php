...
new class extends Component {
    ...
    public function quickInvest()
    {
        $this->dispatch('show-invest-message');
    }
    ...
    <div>
        <div class="w-full bg-gradient-to-br from-green-50 via-blue-50 to-yellow-50 min-h-screen">
            ...
            <div class="relative z-10 container mx-auto px-4 py-8" style="max-width: 1600px;">
                <!-- Hero Header -->
                <div class="bg-gradient-to-r from-green-500 via-teal-500 to-blue-500 rounded-3xl shadow-2xl mb-8 overflow-hidden relative p-8">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            <div>
                                ...
                                <p class="text-xl text-white opacity-90">Investissez dans l'avenir de PARADISIA et récoltez les fruits du succès 🌴</p>
                            </div>
                            @auth
                    ...
                    <!-- Decorative Elements -->
                    <div class="absolute top-0 right-0 text-7xl opacity-20 transform rotate-12">💰</div>
                    <div class="absolute bottom-0 left-0 text-7xl opacity-20 transform -rotate-12">📊</div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 lg:col-span-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="bg-white rounded-2xl shadow-lg p-6 border-2 border-green-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <span class="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full font-bold">Total</span>
                                </div>
                                ...
                                <p class="text-sm {{ $monthlyStats['growth'] > 0 ? 'text-green-600' : 'text-red-600' }} mt-2 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $monthlyStats['growth'] > 0 ? 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' : 'M13 17h8m0 0v-8m0 8l-8-8-4 4-6-6' }}"></path>
                                    </svg>
                                    {{ $monthlyStats['growth'] > 0 ? '+' : '' }}{{ $monthlyStats['growth'] }}% ce mois
                                </p>
                                @endif
                            </div>

                            <!-- Stat 2 - Investisseurs -->
                            <div class="bg-white rounded-2xl shadow-lg p-6 border-2 border-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center">
                                        <span class="text-3xl">👥</span>
                                    </div>
                                    <span class="text-xs bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-bold">Actifs</span>
                                </div>
                                ...
                                <p class="text-sm text-blue-600 mt-2">Communauté active</p>
                            </div>

                            <!-- Stat 3 - Parts Totales -->
                            <div class="bg-white rounded-2xl shadow-lg p-6 border-2 border-yellow-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="w-14 h-14 bg-yellow-100 rounded-xl flex items-center justify-center">
                                        <span class="text-3xl">📊</span>
                                    </div>
                                    <span class="text-xs bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full font-bold">Parts</span>
                                </div>
                                ...
                                <p class="text-sm text-yellow-600 mt-2">Total des parts</p>
                            </div>

                            <!-- Stat 4 - Pays -->
                            <div class="bg-white rounded-2xl shadow-lg p-6 border-2 border-teal-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="w-14 h-14 bg-teal-100 rounded-xl flex items-center justify-center">
                                        <span class="text-3xl">🌍</span>
                                    </div>
                                    <span class="text-xs bg-teal-100 text-teal-700 px-3 py-1 rounded-full font-bold">Global</span>
                                </div>
                                <h3 class="text-gray-600 text-sm mb-2">Pays Investisseurs</h3>
                                <p class="text-2xl font-bold text-gray-900">{{ $countriesCount }}</p>
                                <p class="text-sm text-teal-600 mt-2">Présence mondiale</p>
                            </div>
                        </div>

                        <!-- Current Round -->
                        @if($currentRound)
                        <div class="bg-green-500 rounded-2xl shadow-lg p-6 text-white">
                            <div class="flex items-center justify-between flex-wrap gap-4">
                                <div>
                        ...
                        @else
                        <div class="bg-gradient-to-r from-gray-400 to-gray-500 rounded-2xl shadow-lg p-6 text-white">
                        ...
                        <!-- ROI Simulator -->
                        <div class="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl shadow-lg p-8 border-2 border-orange-200">
                            ...
                            <div class="bg-white rounded-xl p-6 mb-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="number" 
                                                   id="investAmount" 
                                                   wire:model="investAmount"
                                                   value="100000" 
                                                   min="10000" 
                                                   step="10000"
                                                   onchange="calculateROI()"
                                                   class="w-full px-4 py-4 text-2xl font-bold border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                        ...
                                        <input type="range" 
                                               ...
                                               value="100000" 
                                               step="10000"
                                               onchange="updateInvestAmount()"
                                               class="w-full mt-4 h-2 bg-gradient-to-r from-orange-200 to-yellow-200 rounded-lg appearance-none cursor-pointer slider">
                                    ...
                                    <div>
                                        ...
                                        <input type="range" 
                                               ...
                                               class="w-full mt-4 h-2 bg-gradient-to-r from-blue-200 to-teal-200 rounded-lg appearance-none cursor-pointer slider">
                                        <div class="flex justify-between text-xs text-gray-500 mt-2">
                                            <span>1 an</span>
                                            <span>5 ans</span>
                                            <span>10 ans</span>
                                ...
                                <!-- Taux de rendement -->
                                <div class="mt-6 p-4 bg-gradient-to-r from-green-50 to-teal-50 rounded-xl border-2 border-green-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="bg-white rounded-xl p-6 shadow-lg border-2 border-green-200">
                                    <p class="text-sm text-gray-600 mb-2">💰 Capital Final</p>
                                ...
                                <div class="bg-white rounded-xl p-6 shadow-lg border-2 border-blue-200">
                                    <p class="text-sm text-gray-600 mb-2">📈 Gains Totaux</p>
                                    <p id="totalGains" class="text-3xl font-bold text-blue-600">57,352 FCFA</p>
                                    <p class="text-xs text-gray-500 mt-2">Profit net</p>
                                </div>
                                <div class="bg-white rounded-xl p-6 shadow-lg border-2 border-yellow-200">
                                    <p class="text-sm text-gray-600 mb-2">💸 Gains Mensuels</p>
                            ...
                            <div class="mt-6 p-6 bg-white rounded-xl border-2 border-orange-200">
                                <h4 class="font-bold text-gray-800 mb-3 flex items-center gap-2">
                                    <span>📅</span>
                                    Projection Détaillée
                                </h4>
                                <div class="space-y-3" id="yearlyProjection">
                                        ...
                                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="py-4 px-4">
                                                <div class="flex items-center gap-2">
                                                    <div class="w-8 h-8 bg-green-500 to-teal-400 rounded-full flex items-center justify-center text-white text-xs font-bold">
                                            ...
                                            <td class="py-4 px-4 text-sm font-bold text-right text-blue-600">
                                                {{ number_format($payment->share, 0, ',', ' ') }}
                                            </td>
                                            <td class="py-4 px-4 text-sm font-bold text-right text-green-600">
                                                {{ number_format($payment->invested_amount, 0, ',', ' ') }} FCFA
                                            </td>
                    ...
                    <div class="col-span-12 lg:col-span-4 space-y-6">
                        <!-- Quick Invest Card -->
                        <div class="bg-green-500 rounded-2xl shadow-2xl p-6 text-white">
                            <h3 class="text-2xl font-bold mb-4 flex items-center gap-2">
                                <span>⚡</span>
                                Investissement Rapide
                            </h3>
                            <p class="text-green-100 text-sm mb-6">Investissez en quelques clics et commencez à gagner dès aujourd'hui</p>
                            ...
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-4 mb-4">
                                ...
                                <input type="number" 
                                       wire:model="quickInvestAmount"
                                       placeholder="Ex: {{ number_format($currentRound->amount, 0, '', '') }}" 
                                       class="w-full px-4 py-3 rounded-lg bg-white text-gray-900 font-bold text-xl focus:ring-2 focus:ring-white outline-none">
                            </div>
                            ...
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-4 mb-6">
                                ...
                                <div class="flex items-center gap-3">
                                    <button wire:click="$set('quickSharesCount', Math.max(1, $quickSharesCount - 1))" class="w-12 h-12 bg-white bg-opacity-30 rounded-lg font-bold text-2xl hover:bg-opacity-40 transition-all">-</button>
                                    <input type="number" 
                                           wire:model="quickSharesCount"
                                           min="1"
                                           class="flex-1 px-4 py-3 rounded-lg bg-white text-gray-900 font-bold text-xl text-center focus:ring-2 focus:ring-white outline-none">
                                    <button wire:click="$set('quickSharesCount', $quickSharesCount + 1)" class="w-12 h-12 bg-white bg-opacity-30 rounded-lg font-bold text-2xl hover:bg-opacity-40 transition-all">+</button>
                                </div>
                                <p class="text-xs text-green-100 mt-2">Prix par part: {{ number_format($currentRound->amount, 0, ',', ' ') }} FCFA</p>
                            </div>

                            <button onclick="showInvestMessage()" class="w-full bg-white text-green-600 font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-105 flex items-center justify-center gap-2">
                                <span>🚀</span>
                                Investir Maintenant
                            </button>
                            @else
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 text-center">
                                <span class="text-4xl">⏳</span>
                                <p class="mt-3 font-semibold">Round d'investissement non disponible</p>
                                <p class="text-sm text-green-100 mt-2">Revenez bientôt !</p>
                            </div>
                            @endif

                            <p class="text-xs text-green-100 text-center mt-4">Paiement sécurisé • Retrait à tout moment</p>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6 border-2 border-yellow-100">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-3 p-3 {{ $index === 0 ? 'bg-gradient-to-r from-yellow-50 to-transparent' : ($index === 1 ? 'bg-gradient-to-r from-gray-100 to-transparent' : ($index === 2 ? 'bg-gradient-to-r from-orange-50 to-transparent' : 'hover:bg-gray-50')) }} rounded-lg transition-all">
                                    <div class="w-10 h-10 {{ $index === 0 ? 'bg-yellow-400' : ($index === 1 ? 'bg-gray-400' : ($index === 2 ? 'bg-orange-400' : ($index === 3 ? 'bg-blue-400' : 'bg-green-400'))) }} rounded-full flex items-center justify-center font-bold text-white">
                                        {{ $index + 1 }}
                                    </div>
                                    @if($investor->photo)
                        ...
                        <!-- Why Invest -->
                        <div class="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl shadow-lg p-6 border-2 border-blue-200">
                            <h4 class="font-bold text-gray-800 mb-4 flex items-center gap-2">
                                <span class="text-2xl">💡</span>
                                Pourquoi Investir ?
                            </h4>
                            <div class="space-y-3">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600">Investissement durable et responsable</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="investMessageModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center p-4">
                <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center transform transition-all scale-95 opacity-0" id="investMessageContent">
                    <div class="w-20 h-20 bg-gradient-to-br from-green-400 to-teal-400 rounded-full mx-auto flex items-center justify-center mb-6">
                        <span class="text-4xl">🚀</span>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">Bientôt Disponible !</h3>
                    <p class="text-gray-600 mb-6">
                        L'investissement via <span class="font-bold text-green-600">Malpay</span> sera bientôt disponible. 
                        Nous travaillons activement pour vous offrir cette fonctionnalité dans les plus brefs délais.
                    </p>
                    <div class="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-4 mb-6">
                        <p class="text-sm text-gray-600">
                            <span class="text-xl">📧</span> Vous serez notifié dès que le service sera opérationnel !
                        </p>
                    </div>
                    <button onclick="closeInvestMessage()" class="w-full bg-green-500 text-white font-bold py-4 rounded-xl hover:shadow-lg transition-all">
                        J'ai compris
                    </button>
                </div>
            </div>
            ...
            function updateYearlyProjection(amount, duration, rate) {
                ...
                for (let year = 1; year <= duration; year++) {
                    ...
                    div.innerHTML = `
                        <div>
                            <p class="font-semibold text-gray-800">Année ${year}</p>
                            <p class="text-xs text-gray-500">+${yearReturn.toFixed(1)}% cette année</p>
                        </div>
                        <div class="text-right">
                            <p class="font-bold text-green-600">${Math.round(yearCapital).toLocaleString('fr-FR')} FCFA</p>
                            <p class="text-xs text-gray-500">Gain: ${Math.round(yearGain).toLocaleString('fr-FR')} FCFA</p>
                        </div>
                    `;
